        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, width: '100%' }}>
          ...
          <Grid container spacing={{ xs: 2, sm: 3, md: 4 }} justifyContent="center">
            ...
            <Grid item xs={12} sm={6} md={4} sx={{ display: 'flex' }}>
              <Grow in={loaded} timeout={1000} style={{ transformOrigin: '0 0 0', display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%' }}>
                <Card
                  elevation={6}
                  sx={{
                    height: '100%',
            ...
            {/* Teacher Card */}
            <Grid item xs={12} sm={6} md={4} sx={{ display: 'flex' }}>
              <Grow in={loaded} timeout={1200} style={{ transformOrigin: '0 0 0', display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%' }}>
                <Card
                  elevation={6}
                  sx={{
                    height: '100%',
            ...
            {/* Student Card */}
            <Grid item xs={12} sm={6} md={4} sx={{ display: 'flex' }}>
              <Grow in={loaded} timeout={1400} style={{ transformOrigin: '0 0 0', display: 'flex', flexDirection: 'column', flexGrow: 1, width: '100%' }}>
                <Card
                  elevation={6}
                  sx={{
                    height: '100%',
